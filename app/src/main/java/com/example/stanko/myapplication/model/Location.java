package com.example.stanko.myapplication.model;
...
public class Location {
    ...
    public String toString() {
        ...
        return String.format("%-25s %s", name, stringBuilder.toString());
    }
    ...
    private double getProgressValue() {
        if (signalStrength >= SIGNAL_STRENGTH_STRONG) {
            ...
            final double percentage = (SIGNAL_STRENGTH_STRONG - signalStrength) / RANGE;
